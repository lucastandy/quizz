...
function createQuestion(i){
    ...
    questions[i].answers.forEach(function(answer, i){
        // O trecho de código abaixo cria o template do botão do quizz
        ...
        // Inseririndo a alternativa na tela
...
function nextQuestion(){
    // Time para usuário ver as repostas
    setTimeout(function(){
...
// Executando a função init. Inicia o quizz
init();
